/*
This "video.js" file is credit towards Xiao Ling, GitHub username: yushulx
There were a few modifications made to this code to make it usable for our project
 */
...
var barcode_result = document.getElementById('manual_input');
...
var decodeCallback = function (ptr, len, resultIndex, resultCount) {
  ...
  var id = String.fromCharCode.apply(null, result);
  
  
  barcode_result.value = id;
...
buttonGo.onclick = function () {
  ...
  isPaused = false;
  scanBarcode();
  buttonGo.disabled = false;	//MODIFIED
};
